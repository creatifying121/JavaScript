...
console.log(`Title: ${title}, Author: ${author} and ISBN: ${isbn}`);
...
console.log(
  `Language: ${language} and Programming Language: ${programmingLanguage}`
);
...
printBookInfo({ title: "Frontend", author: "Shivani Raichandani" });
